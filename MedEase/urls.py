...
from MedEase.views import (
    PhysicianList, NurseList, PatientList, AppointmentList, RegistrationList, DiagnosisList,
    PhysicianDetail, NurseDetail, PatientDetail, AppointmentDetail, RegistrationDetail, VisitList, VisitDetail,
    DiagnosisDetail,
    PhysicianCreate, NurseCreate, PatientCreate, AppointmentCreate, RegistrationCreate, VisitCreate, DiagnosisCreate,
    PhysicianUpdate, NurseUpdate, PatientUpdate, AppointmentUpdate, RegistrationUpdate, VisitUpdate, DiagnosisUpdate,
    PhysicianDelete, NurseDelete, HaveTestCreate, HaveTestList, PatientDelete, AppointmentDelete, RegistrationDelete,
    VisitDelete, HaveTestDetail, PrescriptionList, PrescriptionDetail, PrescriptionUpdate, PrescriptionCreate,
    HaveTestUpdate,
)
...
urlpatterns = [
    ...
    path("haveTest/<int:pk>/", HaveTestDetail.as_view(), name="MedEase_haveTest_detail_urlpattern"),
    path("diagnosis/", DiagnosisList.as_view(), name="MedEase_diagnosis_list_urlpattern"),
    path("diagnosis/<int:pk>/", DiagnosisDetail.as_view(), name="MedEase_diagnosis_detail_urlpattern"),
    path("prescription/", PrescriptionList.as_view(), name="MedEase_prescription_list_urlpattern"),
    path("prescription/<int:pk>/", PrescriptionDetail.as_view(), name="MedEase_prescription_detail_urlpattern"),
